#
#  Be sure to run `pod spec lint ESMacros.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/EverydayStep/ESMacros.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ESMacros/ESMacros/*.{h,m}"
